...
<li class="subli"><a href="index.php?q=e_impromptu<?php echo (isset($_GET['mobile'])? '&mobile':'') ?>">IMPROMPTU</a></li>
</ul></li>
    <li class="mainli"><a href="index.php?q=e_about-us<?php echo (isset($_GET['mobile'])? '&mobile':'') ?>">ABOUT US</a></li>
<li class="mainli"><a
href="index.php?q=e_contacts<?php echo (isset($_GET['mobile'])? '&mobile':'') ?>">CONTACTS</a></li> 
<li class="mainli"><a href="index.php?q=e_partners<?php echo (isset($_GET['mobile'])? '&mobile':'') ?>">PARTNERS</a></li> </ul>
<?php 
} else {
            if($LANGUAGE=="Hindi")
            {
